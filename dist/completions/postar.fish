...
complete -c postar -n "__fish_postar_needs_command" -f -a "init" -d 'Initializes the configuration files'
complete -c postar -n "__fish_postar_needs_command" -f -a "list-folders" -d 'Lists all the folders for a specific mailbox'
complete -c postar -n "__fish_postar_needs_command" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c postar -n "__fish_postar_using_subcommand completions" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c postar -n "__fish_postar_using_subcommand list-folders" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c postar -n "__fish_postar_using_subcommand help; and not __fish_seen_subcommand_from completions init list-folders help" -f -a "completions" -d 'Outputs shell completions to stdout.'
complete -c postar -n "__fish_postar_using_subcommand help; and not __fish_seen_subcommand_from completions init list-folders help" -f -a "init" -d 'Initializes the configuration files'
complete -c postar -n "__fish_postar_using_subcommand help; and not __fish_seen_subcommand_from completions init list-folders help" -f -a "list-folders" -d 'Lists all the folders for a specific mailbox'
complete -c postar -n "__fish_postar_using_subcommand help; and not __fish_seen_subcommand_from completions init list-folders help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
